# To fetch client subscription details
...
# Integrates the module Keyvault and provides values
module "keyvault" {
...
# Integrates the module sql_db and provides values
module "sql_db" {
...
# Integrates the module webapp and provides values
module "webapp" {
...
# Integrates the module acr and provides values
module "acr" {
  source       = "./modules/acr"
...
# Integrates the module aks and provides values
module "aks" {
  source         = "./modules/aks"
