# to create random password for DB
resource "random_password" "sql_password" {
  length  = 16
  special = true
}

# Creates SQL Server, based on which DB will be created
...
# Firewall rule to allow All Azure Services to access the DB
...
# Firewall rule to allow my app's IP to access the DB
...
# Secret to store name of SQL Admin Username in Keyvault
