# creates an app service plan to host webapp
...
# creates a Linux Web App Service to host/deploy webapps
resource "azurerm_linux_web_app" "web_app" {
  ...
  app_settings = {
    ...
    "SQL_PASSWORD" = var.sql_admin_password # Store securely via Key Vault ideally
