# creates an Azure Kubernetes service to host/deploy webapps
...
# assigns the Kubernetes cluster access to pull Docker images from Azure Container Registry
...
# Assigns the Kubernetes secrets to access secrets from Keyvault
...
# Assigns the Kubernetes cluster to access secrets from Keyvault
